...
SOURCES = tcl_wrap.cxx tcl_typemap.cxx tcl_class.cxx tcl_widgetbehavior.cxx tcl_proxyinlet.cxx tcl_setup.cxx tcl_loader.cxx
...
INCLUDES = -I"$(PD_INCLUDE)/pd" -I../../../pd/src
CFLAGS = $(INCLUDES) -Wall -W -g -funroll-loops -fno-operator-names -fno-omit-frame-pointer -falign-functions=16 -fPIC
LDFLAGS =  
LIBS = -ltcl85
