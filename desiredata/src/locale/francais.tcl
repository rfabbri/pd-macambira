...
say label "Étiquette"
say wherelabel "Où montrer l'étiquette"
say symto "Symbole d'envoi"
say symfrom "Symbole de reception"

say_category "Propriétés du graphe"
say x1   "Depuis x"
say x2   "Vers x"
...
say section_color "couleurs"
 ...
 say wire_color "cordon"
  ...
  say futurewiredash "nouveau cordon (en pointillé)"
...
say wirewirearrow "Flèche blanche"
say viewtooltip "ToolTip"
say canvasinsert_object "Insérer un objet"
say canvaschain_object "Enchaîner un objet"
...
say Helvetica "Helvetica (sans sérif)"
say Times         "Times (serif)"
say add "Ajouter"
say up "Vers le haut"
...
say no_matches "(non trouvé)"
say preset "préréglage"
