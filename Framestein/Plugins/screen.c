	...
	switch(f1.pixelformat)
	{
		case 16:
			...
			for(y = 0; y < h; y++) 
			{
				...
				for(x = 0; x < w; x++)
				{
					r = klamp255(255 - ( (255-r16(pix1_16[x])) * (255-r16(pix2_16[x]) ) / 255 ));
					g = klamp255(255 - ( (255-g16(pix1_16[x])) * (255-g16(pix2_16[x]) ) / 255 ));
					b = klamp255(255 - ( (255-b16(pix1_16[x])) * (255-b16(pix2_16[x]) ) / 255 ));
		...
		case 24:
			for(y = 0; y < h; y++) 
			{
				...
				for(x = 0; x < w; x++)
				{
					r = klamp255(255 - ( (255-r24(pix1_24[x])) * (255-r24(pix2_24[x]) ) / 255 ));
					g = klamp255(255 - ( (255-g24(pix1_24[x])) * (255-g24(pix2_24[x]) ) / 255 ));
					b = klamp255(255 - ( (255-b24(pix1_24[x])) * (255-b24(pix2_24[x]) ) / 255 ));
		...
		case 32:
			for(y = 0; y < h; y++) 
			{
				...
				for(x = 0; x < w; x++)
				{
					r = klamp255(255 - ( (255-r32(pix1_32[x])) * (255-r32(pix2_32[x]) ) / 255 ));
					g = klamp255(255 - ( (255-g32(pix1_32[x])) * (255-g32(pix2_32[x]) ) / 255 ));
					b = klamp255(255 - ( (255-b32(pix1_32[x])) * (255-b32(pix2_32[x]) ) / 255 ));
